-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'TEAM_LEAD', 'TEAM_MEMBER');
...
-- AddForeignKey
ALTER TABLE "TeamMember" ADD CONSTRAINT "TeamMember_teamLeadId_fkey" FOREIGN KEY ("teamLeadId") REFERENCES "TeamLead"("id") ON DELETE SET NULL ON UPDATE CASCADE;
